...
lab0 = sym.Symbol('lab0')
l01x = sym.Symbol('l01x')
l01y = sym.Symbol('l01y')
l12  = sym.Symbol('l12')
l23  = sym.Symbol('l23')
...
print("# Transform arm base to ground")
print("tg_ab = ", tg_ab)
tab_0 = sym.Matrix([
    [1,     0,     0, lab0],
    [0, c(t0), -s(t0),    0],
...
# EE
trans_to_ground = sym.simplify(tg_ab*tab_0*t0_1*t2_1*t3_2*tee_3)
...
# J3
trans_to_ground = sym.simplify(tg_ab*tab_0*t0_1*t2_1*t3_2)
...
# J2
trans_to_ground = sym.simplify(tg_ab*tab_0*t0_1*t2_1)
...
# J1
trans_to_ground = sym.simplify(tg_ab*tab_0*t0_1)
...
# J0
trans_to_ground = sym.simplify(tg_ab*tab_0)
